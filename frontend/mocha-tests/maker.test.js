...
describe("maker", function () {
  ...
  it("turn values to a query", function (done) {
    maker
      ...
      .should.equal(
        "?value1=This%20is%20a%20title&value2=This%20is%20the%20message",
      );
    done();
  });
    ...
    maker.sendEvent(
      {
        ...
        level: levels.toLowerCase(levels.WARN),
      },
...
describe("multi announcement maker", function () {
  var maker = require("../lib/plugins/maker")({
    extendedSettings: {
      maker: {
        key: "use announcementKey instead",
        announcementKey: "12345 6789",
      },
    },
  });
  ...
  it("send 2 requests for the 2 keys", function (done) {
    ...
    maker.makeKeyRequest = function expect2Keys(
      key,
      event,
      eventName,
      callback,
