...
function parseToMoment(value) {
  ...
  if (Array.isArray(value)) {
    ...
    if (typeof value === "number") {
      ...
      if (m.valueOf() < apiConst.MIN_TIMESTAMP) m = moment.unix(m);

      if (!m.isValid() || m.valueOf() < apiConst.MIN_TIMESTAMP) return null;
    ...
    if (typeof value === "string") {
      ...
      if (!m.isValid()) m = moment.parseZone(value, moment.RFC_2822);
