...
function configure(app, wares, env, ctx) {
  ...
  api.use(wares.extensions(["json", "svg", "csv", "txt", "png", "html", "js"]));
  ...
  api.get("/status", function (req, res) {
    ...
    var info = {
      ...
      careportalEnabled:
        app.enabled("api") && env.settings.enable.indexOf("careportal") > -1,
      boluscalcEnabled:
        app.enabled("api") && env.settings.enable.indexOf("boluscalc") > -1,
      settings: settings,
