...
function configure(app, wares, ctx) {
  ...
  api.get("/profile/", function (req, res) {
    const limit =
      req.query && req.query.count
        ? Number(req.query.count)
        : consts.PROFILES_DEFAULT_COUNT;
  ...
  function config_authed(app, api, wares, ctx) {
    ...
    api.post(
      "/profile/",
      ctx.authorization.isPermitted("api:profile:create"),
      function (req, res) {
        var data = req.body;
    ...
    api.put(
      "/profile/",
      ctx.authorization.isPermitted("api:profile:update"),
      function (req, res) {
        var data = req.body;
    ...
    api.delete(
      "/profile/:_id",
      ctx.authorization.isPermitted("api:profile:delete"),
      function (req, res) {
