  ...
  weektoweek.report = function report_weektoweek(
    ...
    function drawChart(week, sgvData, options) {
      ...
      tickValues = client.ticks(client, {
        scaleY:
          options.weekscale === report_plugins.consts.SCALE_LOG
            ? "log"
            : "linear",
      ...
      xScale2 = d3.scaleTime().domain(d3.extent(sgvData, dateFn));
      ...
      var contextCircles = context.selectAll("circle").data(sgvData);
