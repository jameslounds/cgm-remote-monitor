...
function init(env, authorization) {
  ...
  endpoints.get(
    "/permissions",
    authorization.isPermitted("admin:api:permissions:read"),
  ...
  endpoints.get(
    "/subjects",
    authorization.isPermitted("admin:api:subjects:read"),
    function getSubjects(req, res) {
      res.json(
        _.map(authorization.storage.subjects, function eachSubject(subject) {
  ...
  endpoints.post(
    "/subjects",
    authorization.isPermitted("admin:api:subjects:create"),
    function createSubject(req, res) {
      authorization.storage.createSubject(
        req.body,
        function created(err, created) {
          if (err) {
            res.sendJSONStatus(
              res,
  ...
  endpoints.put(
    "/subjects",
    authorization.isPermitted("admin:api:subjects:update"),
  ...
  endpoints.delete(
    "/subjects/:_id",
    authorization.isPermitted("admin:api:subjects:delete"),
    function deleteSubject(req, res) {
      authorization.storage.removeSubject(
        req.params._id,
  ...
  endpoints.get(
    "/roles",
    authorization.isPermitted("admin:api:roles:list"),
  ...
  endpoints.post(
    "/roles",
    authorization.isPermitted("admin:api:roles:create"),
    function createSubject(req, res) {
      authorization.storage.createRole(
        req.body,
        function created(err, created) {
          if (err) {
            res.sendJSONStatus(
  ...
  endpoints.put(
    "/roles",
    authorization.isPermitted("admin:api:roles:update"),
  ...
  endpoints.delete(
    "/roles/:_id",
    authorization.isPermitted("admin:api:roles:delete"),
